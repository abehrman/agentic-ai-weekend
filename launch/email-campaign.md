# AgentX email campaign

## Announcement email — from Adam
...
The gap I keep seeing is not access to AI. It is knowing how to make AI useful, reliable, and personal without giving up human judgment.
...
For high-impact choices, AI helps organize research and questions. It does not replace qualified professional advice or your judgment.
...
## Email 1 — make AI personal

**Send:** Sunday, August 30  
**Subject:** What would you hand to a capable personal assistant?  
**Preheader:** Start with one real goal. Build a system around it.

Most people use AI like a search box: ask a question, get an answer, start over tomorrow.

An agent works differently. It can take a goal, use approved context and tools, check its work, remember what you choose, and return control to you before anything important happens.

In the Agentic AI Intensive, you will build that system around a real part of your life.

- An entrepreneur can research a market and organize a launch.
- A family can compare cars, travel plans, budgets, or financial scenarios.
- A caregiver can gather sources and prepare better questions for a doctor.
- Anyone can organize documents, photos, projects, preferences, and open loops.
...
## Email 2 — understand what “agentic” means

**Send:** Friday, September 4  
**Subject:** Chatbot, agent, agentic system: the useful difference  
**Preheader:** Learn the language, then build the system.

You do not need to become a programmer to understand agentic AI.

You do need a clear mental model.

In the October AgentX course, we build that model one layer at a time:

1. An **LLM** understands and generates language from your instructions and context.
