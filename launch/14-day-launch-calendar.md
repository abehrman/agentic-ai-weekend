...
|---|---|---|---|---|
| 1 | Thu, Aug 27 | Announcement email and LinkedIn launch post | Send 10 personal notes to people who know Adam’s work | Replies, course-page visits, enrollments |
| 2 | Fri, Aug 28 | Facebook post | Reply to every substantive question within the day | Questions and objections by theme |
| 3 | Sat, Aug 29 | Instagram post and story | Ask five trusted contacts to forward the referral text to one suitable person | Referral replies and shares |
...
| 11 | Sun, Sep 6 | LinkedIn follow-up 2: multigenerational use cases | Ask three community connectors for one direct introduction each | Introductions and enrollments |
| 12 | Mon, Sep 7 | Re-share the strongest-performing factual post | Send the referral text to the next 10 suitable personal contacts | Replies by source |
| 13 | Tue, Sep 8 | Course-build visual: goal → context → tools → evidence → approval | Follow up with community organizations that opened or replied | Newsletter placements |
| 14 | Wed, Sep 9 | Email 3: launch tuition ends September 13 | Send a concise factual deadline note to active prospects only | Enrollments and unresolved questions |
...
1. Confirm checkout still works before publishing a payment link.
2. Use the assigned tagged URL from `utm-matrix.csv`.
3. Reply to questions with facts from the site and `claims-safety-checklist.md`.
4. Record source, reply, enrollment, and common objection in one simple tracker.
5. Report remaining seats only from paid Stripe enrollments, never from interest or page visits.
